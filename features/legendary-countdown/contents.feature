Feature: Display Contents of Villain Deck
  ...
  Scenario Outline: Villain Deck Setup for <scheme> with <players> players
    ...
    |       1 | Replace Earth's Leaders with Killbots       |           5 |             8 |              3 |               0 |          18 | Killbots (Bystander cards) |
    |       2 | Replace Earth's Leaders with Killbots       |           5 |            16 |             10 |               0 |          18 | Killbots (Bystander cards) |
    |       3 | Replace Earth's Leaders with Killbots       |           5 |            24 |             10 |               0 |          18 | Killbots (Bystander cards) |
    |       4 | Replace Earth's Leaders with Killbots       |           5 |            24 |             20 |               0 |          18 | Killbots (Bystander cards) |
    |       5 | Replace Earth's Leaders with Killbots       |           5 |            32 |             20 |               0 |          18 | Killbots (Bystander cards) |
